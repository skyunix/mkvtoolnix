...
static language_init_t const s_languages_init[] = {
  ...
  { "Albanian",                                                   "sqi",     "sq", "alb", true,  false },
  ...
  { "Armenian",                                                   "hye",     "hy", "arm", true,  false },
  ...
  { "Greek (modern, 1453-)",                                      "ell",     "el", "gre", true,  false },
  ...
  { "Icelandic",                                                  "isl",     "is", "ice", true,  false },
  ...
  { "Macedonian",                                                 "mkd",     "mk", "mac", true,  false },
  ...
  { "Malay (macrolanguage)",                                      "msa",     "ms", "may", true,  false },
  ...
  { "Romanian",                                                   "ron",     "ro", "rum", true,  false },
...
void
init() {
  g_languages.reserve(8781);

  for (language_init_t const *lang = s_languages_init, *end = lang + 8781; lang < end; ++lang)
